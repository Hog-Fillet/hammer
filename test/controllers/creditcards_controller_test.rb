...
class CreditcardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create creditcard' do
    assert_difference('Creditcard.count') do
      post creditcards_url,
           params: { creditcard: { address: @creditcard.address, cardnumber: @creditcard.cardnumber, country: @creditcard.country,
                                   cvv: @creditcard.cvv, exp: @creditcard.exp, name: @creditcard.name, network: @creditcard.network, user_id: @creditcard.user_id } }
    end
  ...
  test 'should update creditcard' do
    patch creditcard_url(@creditcard),
          params: { creditcard: { address: @creditcard.address, cardnumber: @creditcard.cardnumber, country: @creditcard.country,
                                  cvv: @creditcard.cvv, exp: @creditcard.exp, name: @creditcard.name, network: @creditcard.network, user_id: @creditcard.user_id } }
